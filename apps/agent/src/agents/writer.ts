...
${angle ? `- The piece argues the thesis above and takes the "${angle.shape}" shape. The
  brief's sections execute that; do not quietly rearrange them back into the
  running order every other article on this site uses.
